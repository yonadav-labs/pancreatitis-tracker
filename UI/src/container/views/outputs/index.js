						...
						<div className="row mb-5">
							<div className="col-xs-12 col-sm-6">
								...
								<div>
									...
									<CustomProgressBar title="RANSON" value="60" text="60%" />
								</div>
							</div>
							<div className="col-xs-12 col-sm-6">
								...
								<div className="row">
									<div className="col-6">
										<div className="rule-btn primary-rule"><span className="rule-text">Unlikely</span></div>
									...
									<div className="col-6">
										<div className="rule-btn primary-rule"><span className="rule-text">Likely</span></div>
										<div className="rule-btn"><span className="rule-text">Rule 1</span></div>
										<div className="rule-btn"><span className="rule-text">Rule 1</span></div>
										<div className="rule-btn"><span className="rule-text">Rule 1</span></div>
										<div className="rule-btn"><span className="rule-text">Rule 1</span></div>
